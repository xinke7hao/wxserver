...
<script src="js/chart/paiduser-chart.js"></script>
<div class="messagepop pop">
<table align="center">
	<tr>
		<td><select multiple id="unselectList">
			<c:forEach items="${facts}" var="m">
				<option value="${m.uuid}" title="${m.name}">${m.uuid}-${m.name}</option>
			</c:forEach>
			</select>
		</td>
		<td>
...
<div class="bossToolBar">
	...
	<a href="javascript:resetUrl('chart/paiduser');" class="button reload">重置</a><br/>
...
<div id="paiduserChart" style="height:450px;"></div>
<div id="paidcountChart" style="height:450px;"></div>
