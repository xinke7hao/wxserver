...
<script src="js/chart/paytime-chart.js"></script>
...
<div class="bossToolBar">
	...
	<input type="hidden" name="productType" value="0" /></label>
	<label id="products" class="radio-group-line">
	<label><input type="checkbox" id="chkAllProduct" />全选</label>
	<label><input type="checkbox" name="productId" title="VIP" value="1" />VIP</label>
	<label><input type="checkbox" name="productId" title="单点" value="-2" />单点</label>
	<label><input type="checkbox" name="productId" title="集合" value="2" />集合</label>
	</label>
