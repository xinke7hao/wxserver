/************************************************************************************
 * @File name   :      StatisPlatformCsvView.java
 *
 * @Author      :      XuYanbo
 *
 * @Date        :      2015年1月26日
 ...
 * @author XuYanbo
 */
public class StatisPlatformCsvView extends AbstractCsvView {
	...
	protected void buildCsvDocument(Map<String, Object> model,
		...
		String[] header = {"平台名称","支付流水总数","已结单的支付流水数","总金额(元)","同步返回数","异步返回数","天对账失败数","业务方处理失败数","统计日期","创建时间"};
		CSVWriter cw = null;
		
		try {
			response.setHeader("Content-Disposition","attachment; filename=\"statis-platform.csv\"");
