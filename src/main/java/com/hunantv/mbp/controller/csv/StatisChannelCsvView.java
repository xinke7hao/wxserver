/************************************************************************************
 * @File name   :      StatisChannelCsvView.java
 *
 * @Author      :      XuYanbo
 *
 * @Date        :      2015年1月26日
 ...
 * @author XuYanbo
 */
public class StatisChannelCsvView extends AbstractCsvView {
	...
	protected void buildCsvDocument(Map<String, Object> model,
		...
		String[] header = {"支付渠道英文名","支付渠道中文名","支付流水总数","已结单的支付流水数","总金额(元)","同步返回数","异步返回数","统计日期","创建时间"};
		CSVWriter cw = null;
		
		try {
			response.setHeader("Content-Disposition","attachment; filename=\"statis-channel.csv\"");
